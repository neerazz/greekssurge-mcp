...
const QUERY_TOKEN_PATTERN = /([?&](?:access_token|token|gs_token|id_token|refresh_token)=)[^&\s]+/gi;
const KV_TOKEN_PATTERN = /\b((?:gs_token|access_token|refresh_token|id_token|token)\s*[=:]\s*)[^&\s,"}]+/gi;
