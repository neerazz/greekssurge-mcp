...
Version 0.1.3 is a read-only local stdio MCP server. Keep changes inside that boundary unless a future issue explicitly designs and ships a compliant hosted transport.
